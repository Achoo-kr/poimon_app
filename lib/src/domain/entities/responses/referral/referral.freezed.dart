...
abstract class $ReferralCopyWith<$Res> {
  ...
  @useResult
  $Res call({String nickname, DateTime? expiredAt});
}
...
class _$ReferralImpl implements _Referral {
  const _$ReferralImpl({required this.nickname, required this.expiredAt});
  ...
  @override
  String toString() {
    return 'Referral(nickname: $nickname, expiredAt: $expiredAt)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, nickname, expiredAt);
...
abstract class _Referral implements Referral {
  const factory _Referral(
      ...
      required final DateTime? expiredAt}) = _$ReferralImpl;
