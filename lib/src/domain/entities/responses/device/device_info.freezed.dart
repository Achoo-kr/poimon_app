...
class _$DeviceInfoAndroidImpl implements DeviceInfoAndroid {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$DeviceInfoAndroidImpl);
  }
...
abstract class DeviceInfoAndroid implements DeviceInfo {
  const factory DeviceInfoAndroid() = _$DeviceInfoAndroidImpl;
}
...
class _$DeviceInfoIosImpl implements DeviceInfoIos {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$DeviceInfoIosImpl);
  }
...
abstract class DeviceInfoIos implements DeviceInfo {
  const factory DeviceInfoIos() = _$DeviceInfoIosImpl;
}
