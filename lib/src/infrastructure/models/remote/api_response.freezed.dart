...
abstract class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T result, String code, String message});
}
...
class _$ApiResponseImpl<T> extends _ApiResponse<T> {
  const _$ApiResponseImpl(
      {required this.result, this.code = '', this.message = ''})
      : super._();
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(result: $result, code: $code, message: $message)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(result), code, message);
