...
import 'package:poimon_app/src/presentation/pages/widgets/tool_tip/enums.dart';
import 'package:poimon_app/src/presentation/pages/widgets/tool_tip/utils.dart';
import 'package:poimon_app/src/presentation/pages/widgets/tool_tip/bubble_shape.dart';
import 'package:poimon_app/src/presentation/pages/widgets/tool_tip/shape_overlay.dart';
import 'package:poimon_app/src/presentation/pages/widgets/tool_tip/super_tooltip_controller.dart';
import 'package:poimon_app/src/presentation/pages/widgets/tool_tip/tooltip_position_delegate.dart';
...
class SuperTooltip extends StatefulWidget {
  const SuperTooltip({
    ...
    this.clickThrough = false,
         ...
         showDropBoxFilter ? showBarrier ?? false : true,
...
class _SuperTooltipState extends State<SuperTooltip>
  ...
  Future<void> _showTooltip() async {
    ...
    await _animationController.forward().whenComplete(
      _superTooltipController!.complete,
    );
  }
  ...
  Widget _buildCloseButton() {
    ...
    return GestureDetector(
      behavior: HitTestBehavior.opaque,
      onTap: () async => widget.controller!.hideTooltip(),
      child: Padding(
