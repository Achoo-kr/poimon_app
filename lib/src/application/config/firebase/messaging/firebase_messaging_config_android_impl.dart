...
class FirebaseMessagingConfigAndroidImpl implements FirebaseMessagingConfig {
  const FirebaseMessagingConfigAndroidImpl({
  ...
  Future<void> _showNotification(RemoteMessage message) async {
    ...
    await _localNotificationDataSource.showAndroid(
